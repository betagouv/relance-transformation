    ...
    <main class="rf-container"  id="main">
      ...
      <div class="rf-grid-row rf-grid-row--center">
        <div class="rf-col-md-10 rf-col-lg-8">
          ...
          <ul>
            <li>La <a href="#DEMAT"><strong>dématérialisation des services</strong></a> aux usagers (création ou amélioration) </li>
            <li>Un <a href="#DATA"><strong>meilleur usage des données pour nos territoires</strong></a> (intelligence artificielle, open data, archivage, tableaux de bord de pilotage des politiques publiques locales)</li>
            <li>La <a href="#COOP"><strong>coopération avec mes partenaires et usagers</strong></a> grâce au numérique (plateformes citoyennes, gestion de la connaissance partagée, marchés publics)</li>
          </ul>

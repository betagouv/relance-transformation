  ...
  export default {
      ...
      methods: {
          ...
          goToSelection2() {
            ...
            axios.get(`https://aides-territoires.beta.gouv.fr/api/aids/?backers=505-mtfp&in_france_relance=true&targeted_audiences=commune&targeted_audiences=epci&targeted_audiences=department&targeted_audiences=region`)
                  .then(response => {
            ...
            goToEcheance2022() {
              ...
              this.aides = "";
              const axios = require("axios");
              axios.get(`https://aides-territoires.beta.gouv.fr/api/aids/?backers=505-mtfp&in_france_relance=true&targeted_audiences=public_org&recurrence=oneoff&apply_before=2022-12-31`)
                    .then(response => {
                    this.aides = response.data.results;
                    })
            },
            goToEcheance2023() {
              ...
              this.aides = "";
              const axios = require("axios");
              axios.get(`https://aides-territoires.beta.gouv.fr/api/aids/?backers=505-mtfp&in_france_relance=true&targeted_audiences=public_org&recurrence=ongoing`)
                    .then(response => {
                    this.aides = response.data.results;
                    })
            },

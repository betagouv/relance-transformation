      ...
      <div class="rf-grid-row rf-grid-row--center">
        <div class="rf-col">
          ...
          <div class="rf-grid-row rf-grid-row--center rf-grid-row--middle rf-grid-row--gutters rf-margin-bottom-2N">
            <TopSelection :title="topSelection1" :expanded="false" :controls="selectionDate" :filename="logoEtat" :focus="focusTopSelection1" @click.native="goToSelection1()" @keyup.enter.native="goToSelection1" @keyup.space.prevent.native="goToSelection1"></TopSelection>
            <TopSelection :title="topSelection2" :expanded="false" :controls="controls" :filename="logoCollectivite" :focus="focusTopSelection2" @click.native="goToSelection2()" @keyup.enter.native="goToSelection2()" @keyup.space.prevent.native="goToSelection2()"></TopSelection>
          </div>
          ...
          <div v-if="topSelectionEtat" id="selectionDate" >
            ...
            <div v-if="topSelectionEtat" class="rf-grid-row rf-grid-row--center rf-grid-row--middle rf-grid-row--gutters">
              <DateSelection :title="dateSelection1" :aria-expanded="false" :aria-controls="controls" :filename="logo2022" :focus="focusEcheance1" @click.native="goToEcheance2022()" @keyup.enter.native="goToEcheance2022()" @keyup.space.prevent.native="goToEcheance2022()"></DateSelection>
              <DateSelection :title="dateSelection2" :aria-expanded="false" :aria-controls="controls" :filename="logo2023" :focus="focusEcheance2" @click.native="goToEcheance2023()" @keyup.enter.native="goToEcheance2023()" @keyup.space.prevent.native="goToEcheance2023()"></DateSelection>
            </div>
          </div>

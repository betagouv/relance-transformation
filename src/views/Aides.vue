<template>
    <div class="aides">
        <div v-for="item in aide" :key="item.id">
                ...
                <div class="intro mb-5 col-sm">
                    <div class="row align-items-center mb-4">
                        ...
                        <h1 class="greenTitle text-left col-sm"><strong>{{ item.name }}</strong></h1>
                    </div>
                ...
                <div class="exemples text-left my-5 pt-4 col-sm">
                    ...
                    <div>
                        ...
                        <!-- <ul class="h5" v-repeat="item.destinations">
                        <li> {{$value}} </li> 
                        </ul> -->
                    </div>
                </div>
                ...
                <div class="candidater text-left my-5 pt-4 col-sm">
                    ...
                    <div class="buttonCandidater p-3 mt-3 col-sm-3"><a :href="item.application_url" class="text-reset">Candidater à cet appel à projet</a></div>
                </div>
                ...
                <div class="questions text-left my-5 pt-4 col-sm">
                    ...
                    <div v-html="item.contact" class="h5"></div>
                </div>
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        mounted() {
            const axios = require("axios");
            axios.get('https://staging.aides-territoires.beta.gouv.fr/api/aids/')
            .then(response => {
                const aides = response.data.results
                this.aide = aides.filter(aide => aide.id == this.$route.params.id)
                })
        },
